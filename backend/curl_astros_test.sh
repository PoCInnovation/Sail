#!/bin/bash
# Astros Swap Test using Universal Block
# Target: 0xa5a0c25c79e428eba04fb98b3fb2a34db45ab26d4c8faf0d7e39d66a63891e64::swap_router::swap_a_b (Turbos Aggregation)
...
curl -X POST http://localhost:8000/api/simulate \
  ...
  "strategy": {
    ...
    "version": "1.0.0",
    "meta": {
      "name": "Astros Universal Block Test",
      "author": "0xd025128a33db4f04148eddfd994795e38bfb13d1c5f2cb2a2327be92246c13d0",
      "description": "Test Astros swap using universal block",
      "created_at": 1700000000000,
      "updated_at": 1700000000000,
      "tags": ["test", "astros", "universal"]
    },
    "nodes": [
      {
        "id": "borrow_1",
