 ...
 * 
 * Use getAddresses() function to get addresses for the current network
 * Defaults to mainnet if SUI_NETWORK env var is not set
 */
 ...
 * Defaults to mainnet if network is not provided
 */
export function getAddresses(network?: Network): typeof MAINNET_ADDRESSES | typeof TESTNET_ADDRESSES {
  const envNetwork = process.env.SUI_NETWORK as Network;
  const targetNetwork = network || envNetwork || "mainnet";
...
export const MAINNET_ADDRESSES = {
  ...
  // Turbos Finance is only available on testnet, not mainnet
  // TURBOS: undefined on mainnet
};

/**
 * Testnet Addresses
 * 
 * Note: Navi and Cetus testnet addresses need to be verified on SuiScan
 * Turbos Finance testnet addresses are from official documentation
 */
export const TESTNET_ADDRESSES = {
  NAVI: {
    // ⚠️ TODO: Verify Navi testnet addresses on SuiScan
    // For now, using mainnet addresses (will fail on testnet)
    PACKAGE: "0xee0041239b89564ce870a7dec5ddc5d114367ab94a1137e90aa0633cb76518e0",
    STORAGE: "0xbb4e2f4b6205c2e2a2db47aeb4f830796ec7c005f88537ee775986639bc442fe",
    PRICE_ORACLE: "0x1568865ed9a0b5ec414220e8f79b3d04c77acc82358f6e5ae4635687392ffbef",
    FLASHLOAN_CONFIG: "0x3672b2bf471a60c30a03325f104f92fb195c9d337ba58072dce764fe2aa5e2dc",
  ...
  CETUS: {
    // ⚠️ TODO: Verify Cetus testnet addresses on SuiScan
    // For now, using mainnet addresses (will fail on testnet)
  ...
  TURBOS: {
    /**
     * Turbos Finance Testnet Addresses
     * 
     * Source: https://turbos.gitbook.io/turbos/developer-docs/dev-overview#testnet-1
     * Verified: December 2025
     * 
     * Turbos Finance is a Concentrated Liquidity Market Maker (CLMM) DEX
     * Available on testnet for swaps and liquidity provision
     */
    PACKAGE: "0x3526c88f5304c78fb93ed1cc1961d56b8517108550c9938b8a5a0e6c90fbe2a5", // ✅ CLMM Package Testnet
    PUBLISHED_AT: "0xbce833e2aa9266eacad68c8db25e83cb52941a2eba168c4a28bb4aa38a2be9ea",
    CONFIG: {
      pool_config: "0x2041acff5d98b1892ac5be1faa075936a05f64922657dc94c374c43ce2291a8d", // ✅ Pool Config Testnet
      positions: "0x8d916e3eaa3a5ce2949a4d845ec8082f7d46768ffd4c15984c32b3c5f4cabf22", // ✅ Positions Testnet
      versioned: "0x0ec5aedfc4a3a99aebd8a54b6b39df34b7696ada57008c35f69d6b4bb346b5c4", // ✅ Versioned Testnet
    },
    FEE_TIERS: {
      // Fee tiers are shared objects for different fee levels
      "10bps": "0x082ef6ca8112c65a3ceff44c7dd160221ef92d18ad6c0314c95a443dffe16df3",
      "100bps": "0x26b21a736613daa65462d13f3e79b2fe09072a596ec5b0466313df08ab217577",
      "500bps": "0x15d883f76337c7062817eb2231dc62e291474cac4147ee47047029d7df5c7ffb",
      "1000bps": "0x82e9c6626655965f2b5a0b33428a193b7b367d258f0e6b9a43f66efa20ff4f29",
      "2000bps": "0x55799e99561b546d84b194fd81d87aa40b1f91a86e84afb9b51b7efbc6ea2be0",
      "2500bps": "0x73c168d6ec583288ddff9e9cd180ed8c6f0f94f5a77b37b7716bae5f62245bd1",
      "3000bps": "0xdafb286b57abcbb4bd5be7f7930587048250002d4b1f60cdf0874026a3cb4709",
      "10000bps": "0xf7791adbed4be7a4276b1d8d5f83279a709663acc51753fe6bbcf6eb9e2a878c",
      "20000bps": "0x4bf5fb4974bce137ae1c4b6fb6a4149eb14c7654f268be0d2b4a4a4efecd432e"
    }
  }
};
